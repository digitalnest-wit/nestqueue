...
// TroubleshootingDetails captures the lifecycle of investigating and closing a ticket
type TroubleshootingDetails struct {
	InitialObservation string `json:"initialObservation" bson:"initialObservation"`
	StepsTaken         string `json:"stepsTaken" bson:"stepsTaken"`
	RootCause          string `json:"rootCause" bson:"rootCause"`
	SolutionsApplied   string `json:"solutionsApplied" bson:"solutionsApplied"`
...
type Ticket struct {
	...
	Troubleshooting TroubleshootingDetails `json:"troubleshooting" bson:"troubleshooting"`
